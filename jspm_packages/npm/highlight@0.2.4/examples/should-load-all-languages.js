...
(function() {
  ...
  function runTest(err) {
    ...
    assert.strictEqual(Highlight.languages.length, Highlight.loadedLanguages.length, 'not all languages were loaded: ' + Highlight.languages.length + " " + Highlight.loadedLanguages.length);
    assert.deepEqual(Highlight.languages, Highlight.loadedLanguages, 'not all languages were loaded: ' + JSON.stringify(Highlight.languages, null, '  ') + "\n" + JSON.stringify(Highlight.loadedLanguages, null, '  '));
