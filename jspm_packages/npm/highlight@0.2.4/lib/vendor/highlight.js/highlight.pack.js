...
(function(process) {
  ...
  hljs.LANGUAGES.lisp = function() {
    ...
    return {
      ...
      dM: {
        i: "[^\\s]",
        c: [c, o, p, q, a, b, e, l, g, f, j]
      }
    };
  }();
  hljs.LANGUAGES.profile = {dM: {c: [hljs.CNM, {
        cN: "builtin",
        b: "{",
        e: "}$",
        eB: true,
