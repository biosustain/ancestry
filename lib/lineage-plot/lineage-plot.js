    ...
    return {
        ...
        link(scope, element, attributes) {
            ...
            function render(options) {
                ...
                try {
                    typesEnabled = Object.keys(layout.nodeTypes).length > 0;
                }
                catch(e){
                    typesEnabled = false;
                }
                ...
                nodeEnter.append("circle")
                    .attr("r", d => typesEnabled ? types[d.type].r : defaultNode.r)
                    .style("fill", d => {
                    ...
                    .attr("stroke-width", d =>  typesEnabled ? types[d.type].strokeWidth : defaultNode.strokeWidth)
                    .on("click", click)
                    .on("mouseup", mouseUp)
