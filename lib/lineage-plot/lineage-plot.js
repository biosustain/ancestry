...
import { d3legend, d3tooltip, mergeTemplateLayout, createNodeTypes, LabelCollisionDetection, createTreeLayout,
    ...
    testLabelLength, multiAttr, getTranslation, createPlotControls, attachActionOnResize, getBBox, filterSeries} from '../shared-features.js'
    ...
    render(options) {
        ...
        function applyZoom(zoomTransform) {
            ...
            nodeLabel.each(d => {
                ...
                .attr("y", d => d.y)
                .attr("text-anchor", d => d.scaledLabelPos['text-anchor']);
            multiAttr.call(nodeLabel, scaleProperties(layout.nodeLabel, scale));
            ...
            linkLabel.each(d => {
                ...
                .attr("x", d => d.x)
                .attr("y", d => d.y);
            multiAttr.call(linkLabel, scaleProperties(layout.linkLabel, scale));
        ...
        createPlotControls(this.element[0], controls, layout.controlsEnabledOnStart);
