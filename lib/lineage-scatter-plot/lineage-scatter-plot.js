...
import d3 from 'd3'
import { d3tooltip, mergeTemplateLayout, createNodeTypes, createDynamicNodeAttr, roundOffFix, labelCollisionDetection,
    scaleProperties, getNodeLabelBBox} from '../shared-features.js'
        ...
        link(scope, element, attributes) {
            ...
            function render(options) {
                ...
                let plotArea = chart.append("g")
                    ...
                    .attr("clip-path", `url(${$location.path()}#lineage-scatter-clip-rect)`)
                    .append("g");
                ...
                plotArea.selectAll(".link")
                    ...
                    .attr(layout.link)
                    .attr("class", "link")
                    .attr("marker-end", `url(${$location.path()}#marker-arrowhead)`);
