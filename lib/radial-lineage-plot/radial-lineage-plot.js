...
import d3 from 'd3'
import { d3tooltip, createTreeLayout, mergeTemplateLayout, createNodeTypes } from '../shared-features.js'
            ...
            function render(options) {
                ...
                function mouseovered(active) {
                    return function(d) {
                        ...
                        d3.selectAll("g.node-active circle").
                            attr("stroke-width", node => active ? types[node.type].strokeWidth + 1 : types[node.type].strokeWidth);
