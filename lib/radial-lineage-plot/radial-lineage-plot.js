...
import { d3tooltip, d3legend, createTreeLayout, mergeTemplateLayout, calcColourBarSize, drawColourBar,
    createNodeTypes, createDynamicNodeAttr, testLabelLength, multiAttr, createPlotControls,
...
class RadialLineagePlotController {
    ...
    render(options) {
        ...
        let treeData = createTreeLayout(filterSeries(copy.data, this.visibleSeries)),
        ...
        let types = createNodeTypes(copy.data, layout.nodeTypes, this.defaultNode),
